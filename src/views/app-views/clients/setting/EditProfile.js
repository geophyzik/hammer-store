...
export class EditProfile extends Component {
	...
	render() {
		...
		const currentProfile = users.find(user => user.id === id);
		...
		const { name, email, username, dateOfBirth, phone, website, address, postcode, avatarUrl } = currentProfile;
...
export default connect(addStateProps)(withRouter(EditProfile));
